    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="login-register-link">Log in</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="login-register-link">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
...
<?php /**PATH D:\Kuliah\SEM 5\KKN\new Web\desa-kunyayang\resources\views/admin/admin.blade.php ENDPATH**/ ?>